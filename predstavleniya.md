...
Динамическое веб-обслуживание с полной поддержкой распространенных веб-технологий
...
Более быстрый доступ к хранилищу данных
Ограничен из-за небольшого размера экземпляров, не подходит для крупных приложений, которым требуются большие экземпляры виртуальных машин
Сеть не интегрирована
