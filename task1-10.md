...
На основании проведенного анализа был сделан выбор в пользу микросервисной архитектуры с Domain Driven Design, т.к у нас есть четко выделенные бизнес-модули,каждый из которых выполняет свой определенный функционал и имеет виидмые граница как для разработки, так и для бизнеса  
