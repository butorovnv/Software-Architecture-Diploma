...
Минимальными функционалом, критически неоходимым системе для выхода на рынок являются: профиль пользователя, функционал тренировок, трекинг тренировок, шлюз для интеграций. Имея только эти функции можно будетвыполнить релиз приложения для привлечения пользователей
Следующим этапом стоит реализовать мфункционал социального контента, в котором будет формировании ленты пользователя, которая в свою очередь будет состоять из его подписок , статей, рекомендаций.
Далее - реализовываем  функционал сообщений, чтобы до конца реализовать весь возложенный на систему функционал.
И только потом, в последнюю очередь, когда по сути вся система уже готова, стоит вводить возможность in app покупок путем реализации функционала покупок. 
